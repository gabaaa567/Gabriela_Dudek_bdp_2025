-- ST_GeomFromText tworzy obiekt geometryczny na podstawie tekstowego opisu geometrii (wkt)
-- wkt - tekstowy sposob zapisu ksztaltow geometrycznych
TRUNCATE TABLE roads RESTART IDENTITY;
